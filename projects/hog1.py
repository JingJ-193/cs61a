...
def free_bacon(score):
    ...
    if score < 10:
        ...
        result = 10 - min(score % 10，score // 10)
    return result
    # END PROBLEM 2
...
def is_swap(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4
    if player_score <10 and play_score == opponent_score % 10:
        return True
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    # BEGIN PROBLEM 5
    "*** YOUR CODE HERE ***"
    #哈哈哈真好，因为lambda函数卡了两天（大无语！）python给姐爬
    while True:
        if player == 0:
            count = strategy0(score0,score1)
            score0 += take_turn(count,score1,dice)
            ...
            if score0 >= goal:
                ...
                player = other(player)
        if player == 1:
            count = strategy1(score1,score0)
            score1 +=take_turn(count,score0,dice)
            say = say(score0,score1)
            if score1 >= goal:
                break
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    def commentary(score0,score1, previous_high = previous_high, previous_score= preivious_score):
        if who == 0:
            ...
            return annnounce_highest(who, previous_high, previous_score)
        elseif who == 1:
